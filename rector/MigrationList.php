...
use EntelisTeam\Lbaf\Hydrator\Rector\Migration\Migration_20260527_1840_HydratorMoveInternalMethod;
...
final class MigrationList implements RectorMigrationListInterface
{
    ...
    public static function all(): array
    {
        return [
            ...
            Migration_20260527_1840_HydratorMoveInternalMethod::class,
        ];
    }
}
